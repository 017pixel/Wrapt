...
export const pluginsApi = {
  ...
  updatePluginDraft: (id: string, body: PluginDraftContent) => mutate(`/plugins/drafts/${encodeURIComponent(id)}`, "PUT", pluginDraftResponseSchema, { expectedRevision: body.revision, content: body }),
