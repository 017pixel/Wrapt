...
export const systemApi = {
  ...
  updateStatus: (signal?: AbortSignal) => request("/system/update/status", updateStatusResponseSchema, signal),
  triggerUpdate: () => mutate("/system/update", "POST", updateTriggerResponseSchema, {}),
