...
export const settingsSearchCatalog: readonly SettingsSearchEntry[] = [
  {
    ...
    aliases: ["System", "Systemfunktionen", "Dienst", "Neustart", "Neustarten", "Restart", "Reload", "Server", "Frontend", "Backend", "Beides"],
  },
  {
    id: "version",
    title: "Version",
    description: "Aktueller Release-, GitHub- und Backend-Status",
    category: "Allgemein",
    tab: "allgemein",
    anchor: "settings-general-version",
    aliases: ["Release", "Build", "App-Version", "Versionierung", "Changelog", "PWA", "App installieren", "Update", "Aktualisieren", "GitHub", "neueste Version", "Update installieren"],
  },
  {
    id: "update",
    title: "Update von GitHub",
    description: "Neueste Version ziehen, neu bauen und neu starten",
    category: "Allgemein",
    tab: "allgemein",
    anchor: "settings-general-version",
    aliases: ["GitHub", "Pull", "neueste Version", "Update installieren", "Upgrade", "origin", "GitHub-Stand", "lokale Änderungen", "KI-Prompt", "Agent", "Prompt kopieren"],
  },
  {
    id: "design",
    title: "Design",
