    ...
    owner("wrapt.plugins", [
      {
        ...
        route: standardRoute("wrapt.plugins.route.main", "wrapt.plugins.page.main", "/plugins", { mobileNavigation: true }),
        pageRuntime: lazyPageRuntime("plugins", "Plugins", loadPlugins),
        routeRuntime: routeRuntime("/plugins"),
      },
      {
        page: { id: "wrapt.plugins.page.maker", title: "Plugin Maker", description: "Eigene Plugin-Seiten gestalten" },
        route: standardRoute("wrapt.plugins.route.maker", "wrapt.plugins.page.maker", "/plugins/maker"),
        pageRuntime: lazyPageRuntime("plugins", "PluginMaker", loadPlugins),
        routeRuntime: routeRuntime("/plugins/maker"),
      },
      {
        page: { id: "wrapt.plugins.page.runtime", title: "Plugin", description: "Lokale Plugin-Seite" },
        route: standardRoute("wrapt.plugins.route.runtime", "wrapt.plugins.page.runtime", "/plugins/view/:pluginSlug", {
